...
public class Bank {
    ...
    public static void main(String[] args) {
        ...
        Dataset<Row> totalWithdrawls = withdrawals
                .groupBy("person")
                .agg(sum("amount").as("total withdrawls"));

        totalWithdrawls.show();

        if(useCache){
                totalWithdrawls.cache();
        }
        ...
        Dataset<Row> balances = withdrawals
        ...
        Dataset<Row> negativeBalances = balances
                                                .filter("balance < 0");
        ...
        Dataset<Row> descendingOrder = balances
